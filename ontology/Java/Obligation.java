...
public class Obligation extends LegalPosition
{
  ...
  public Obligation(LegalSituation aAntecedent, LegalSituation aConsequent, StateTransition aStateTransition, Contract aContract, Role aDebtor, Role aCreditor, boolean aSurviving, Role... allControllers)
  {
    super(aAntecedent, aConsequent, aStateTransition, aContract, aDebtor, aCreditor, allControllers);
