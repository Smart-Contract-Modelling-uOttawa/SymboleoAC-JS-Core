...
public class Asset extends Resource
{
  ...
  public Asset(Contract aContract, Role... allControllers)
  {
    ...
    if (!didAddContract)
    {
      throw new RuntimeException("Unable to create asset due to contract. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
