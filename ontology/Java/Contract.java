...
public class Contract extends Resource
{
  ...
  public Contract(Role... allControllers)
  {
  ...
  public LegalPosition addLegalPosition(LegalSituation aAntecedent, LegalSituation aConsequent, StateTransition aStateTransition, Role aDebtor, Role aCreditor, Role... allControllers)
  {
    LegalPosition aNewLegalPosition = new LegalPosition(aAntecedent, aConsequent, aStateTransition, this, aDebtor, aCreditor, allControllers);
  ...
  public Asset addAsset(Role... allControllers)
  {
    return new Asset(this, allControllers);
  }
