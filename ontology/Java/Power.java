...
public class Power extends LegalPosition
{
  ...
  public Power(LegalSituation aAntecedent, LegalSituation aConsequent, StateTransition aStateTransition, Contract aContract, Role aDebtor, Role aCreditor, Role... allControllers)
  {
